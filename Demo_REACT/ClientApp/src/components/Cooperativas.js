...
export class Cooperativas extends Component {
    ...
    seleccionarEmpresa = (Cooperativas) => {
        this.setState({
                        ...
                        {this.state.data.map(Cooperativas => {
                            return (
                                <tr>
                                    ...
                                    <td>
                                        <button className="btn btn-primary" onClick={() => { this.seleccionarEmpresa(Cooperativas); this.modalInsertar() }}><FontAwesomeIcon icon={faEdit} /></button>
                                        {"   "}
                                        <button className="btn btn-danger" onClick={() => { this.seleccionarEmpresa(Cooperativas); this.setState({ modalEliminar: true }) }}><FontAwesomeIcon icon={faTrashAlt} /></button>
                                    </td>
                                </tr>
                            )
                        })}
